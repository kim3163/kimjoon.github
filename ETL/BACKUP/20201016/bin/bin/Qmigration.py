...
class QMigration(FileSystemEventHandler):
	...
	def parse(self, filePath) :
		...
		putFlag = self.exportQueue(dataDict, filePath)
...
#			self.mq.put(dataDict['QUEUE_NM'], ast.literal_eval(dataDict['QUEUE_MSG']), use_bson = self.use_bson)
			self.mq.put(dataDict['QUEUE_NM'], dataDict['QUEUE_MSG'], use_bson = self.use_bson)
