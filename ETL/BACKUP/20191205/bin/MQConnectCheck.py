...
#				__LOG__.Trace('%s : Transfer -> %s' % (self.ANIMP_IP, self.ANIMP_CONNECT_IP) )
		...
		self.irisSelect.updateConn(self.UPDATE_CON_LIST, nowDate)
		self.irisSelect.updateDisConn(self.UPDATE_DISCON_LIST)
		self.irisSelect.updateFirDate(self.FIRST_CONN_LIST, nowDate)
