...
class DBLoader():
	def __init__(self, section, cfg):
		...
		self.interval		= self.cfg.getint(section, "INTERVAL")
	...
	def getEmsData(self, oneEqpInfoDict) :
		...
		if ( expEmsIp == None or expEmsIp == '' ) or ( expEmsNm == None or expEmsNm == '' ) or ( vendor == None or vendor == '' ) or ( eqpTyp == None or eqpTyp == '' or eqpTyp not in 'EMS' ) or ( tacsEqpId == None or tacsEqpId == '' ) :
