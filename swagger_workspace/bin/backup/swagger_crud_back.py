...
tableUpdateKeyDict			= {
								...
								'CM_NB_APP_EQUIP_INFO' : {'UPDATEKEY' : 'IPV4_LIST', 'UPDATEKEY2' : 'PORT_LIST'}, 
...
class insert(Resource) :
	...
	@api.response(200, "Success")
	def get(self, table_name) :
		app.logger.debug('{} table insert'.format(table_name))
...
def _init_logger() :
	...
	logging.basicConfig(format = logFormatStr, filename = "api_.log", level=logging.DEBUG)
